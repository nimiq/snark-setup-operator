...
echo 1 | RUST_LOG=info cargo run --bin new_ceremony --release -- --phase phase2 --upload-mode direct --chunk-size 10 --powers 12 --phase1-filename phase2_init --circuit-filename circuit_2992c --server-url http://localhost:8080  --verifier ba154fac00e55e69ea72bb4966e8f19baf5ad8565e1b67018800b6570828618c --participant 7dfff91466cbe1a42aa9cb613213e6c6d6c012ee03fac0f7512d330fd420d319 --output-dir ./snark-setup-coordinator/coordinator-service/.storage --unsafe-passphrase --keys-file $BASE_DIR/nimiq-verifier.keys --deployer ba154fac00e55e69ea72bb4966e8f19baf5ad8565e1b67018800b6570828618c
...
echo 1 | RUST_LOG=info cargo run --release  --bin control -- --phase phase2 -i new_challenge.query -I new_challenge.full --unsafe-passphrase --keys-file $BASE_DIR/nimiq-verifier.keys --chunk-size 10 --phase1-powers 12 --phase1-filename phase2_init --circuit-filename circuit_2992c --coordinator-url http://localhost:8080 new-round --verify-transcript --expected-participant 7dfff91466cbe1a42aa9cb613213e6c6d6c012ee03fac0f7512d330fd420d319 --new-participant 2238a626c0cbd0c3357da185c438755a2426284abfb293c664f66ce237761a07 --publish --shutdown-delay-time-in-secs 10
