...
echo 1 | RUST_LOG=info cargo run --release  --bin control -- --phase phase1 --unsafe-passphrase --keys-file $BASE_DIR/nimiq-verifier.keys --coordinator-url http://localhost:8080 new-round --verify-transcript --expected-participant 7dfff91466cbe1a42aa9cb613213e6c6d6c012ee03fac0f7512d330fd420d319 --new-participant 2238a626c0cbd0c3357da185c438755a2426284abfb293c664f66ce237761a07 --publish --shutdown-delay-time-in-secs 10
